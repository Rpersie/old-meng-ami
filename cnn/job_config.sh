...
export ENC_KERNELS=( 3 3 2 2 )        # Assume square kernels (AxA)
export ENC_POOLS=( 3 3 0 0 )          # Pool only in frequency; no overlap. Use 0 to indicate no pooling
...
export DEC_KERNELS=( 2 2 3 3 )        # Assume square kernels (AxA)
export DEC_POOLS=( 0 0 3 3 )          # Pool only in frequency; no overlap. Use 0 to indicate no pooling
