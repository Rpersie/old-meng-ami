...
export ENC_CHANNELS=( 256 256 128 64 )
export ENC_KERNELS=( 3 3 3 3 )        # Assume square kernels (AxA)
export ENC_POOLS=( 3 3 2 0 )          # Pool only in frequency; no overlap. Use 0 to indicate no pooling
...
export DEC_CHANNELS=( 64 128 256 256 )
export DEC_KERNELS=( 3 3 3 3 )        # Assume square kernels (AxA)
export DEC_POOLS=( 0 2 3 3 )          # Pool only in frequency; no overlap. Use 0 to indicate no pooling
