...
export ENC_CHANNELS=( 32 32 32 32 )
export ENC_KERNELS=( 3 3 3 3 )        # Assume square kernels (AxA)
export ENC_POOLS=( 2 2 2 2 )          # Pool only in frequency; no overlap. Use 0 to indicate no pooling
...
export DEC_CHANNELS=( 32 32 32 32 )
export DEC_KERNELS=( 3 3 3 3 )        # Assume square kernels (AxA)
export DEC_POOLS=( 2 2 2 2 )          # Pool only in frequency; no overlap. Use 0 to indicate no pooling
