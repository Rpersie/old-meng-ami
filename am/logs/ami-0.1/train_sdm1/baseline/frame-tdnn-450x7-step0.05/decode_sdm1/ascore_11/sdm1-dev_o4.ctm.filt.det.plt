...
set noxtics
set noytics
set title 'DET plot for /data/sls/r/u/atitus5/meng/am/logs/ami-0.1/train_sdm1/baseline/frame-tdnn-450x7-step0.05/decode_sdm1/ascore_11/sdm1-dev_o4.ctm.filt'
set nokey
...
plot [-3.290527:3.290527] [-3.290527:3.290527] \
 "/data/sls/r/u/atitus5/meng/am/logs/ami-0.1/train_sdm1/baseline/frame-tdnn-450x7-step0.05/decode_sdm1/ascore_11/sdm1-dev_o4.ctm.filt.det.dat.00" using 2:1 title "sdm1-dev_o4.ctm" with lines 1
set ytics
set xtics
set size 1.0, 1.0
set key
